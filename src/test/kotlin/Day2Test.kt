...
internal class Day2Test {
    ...
    fun program1() {
        ...
        Assert.assertEquals(listOf(2L, 0, 0, 0, 99), computer.next())
    ...
    fun program2() {
        ...
        Assert.assertEquals(listOf(2L, 3, 0, 6, 99), computer.next())
        Assert.assertFalse(computer.hasNext())
    }
    ...
    fun program3() {
        ...
        Assert.assertEquals(listOf(2L, 4, 4, 5, 99, 9801), computer.next())
        Assert.assertFalse(computer.hasNext())
    }
    ...
    fun program4() {
        ...
        Assert.assertEquals(listOf(30L, 1, 1, 4, 2, 5, 6, 0, 99), computer.asSequence().last())
        Assert.assertFalse(computer.hasNext())
    }
