...
@Tag("IntCodeComputer")
class IntCodeComputerDay2Test {

    @Test
    fun `program 1`() {
        val computer = IntCodeComputerFactory.buildBasicComputer(listOf(1, 0, 0, 0, 99))
    ...
    @Test
    fun `program 2`() {
        val computer = IntCodeComputerFactory.buildBasicComputer(listOf(2, 3, 0, 3, 99))
    ...
    @Test
    fun `program 3`() {
        val computer = IntCodeComputerFactory.buildBasicComputer(listOf(2, 4, 4, 5, 99, 0))
    ...
    @Test
    fun `program 4`() {
        val computer = IntCodeComputerFactory.buildBasicComputer(
            listOf(
                1,
                1,
                1,
