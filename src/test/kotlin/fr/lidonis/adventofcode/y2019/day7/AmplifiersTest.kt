...
class AmplifiersTest {
    ...
    fun `Max thruster 43210`() {
        val amplifiers = Amplifiers(
                listOf(3, 15, 3, 16, 1002, 16, 10, 16, 1, 16, 15, 15, 4, 15, 99, 0, 0),
                listOf(4, 3, 2, 1, 0)
        )
        assertThat(amplifiers.run()).isEqualTo(43210)
    }
    ...
    fun `Max thruster 54321`() {
        ...
        assertThat(amplifiers.run()).isEqualTo(54321)
    }
    ...
    fun `Max thruster 65210`() {
        ...
        assertThat(amplifiers.run()).isEqualTo(65210)
    }
    ...
    fun `Max thruster 139629729`() {
        ...
        assertThat(amplifiers.run()).isEqualTo(139629729)
    }
